...
public class TestEncrypte{
	...
	public static void main(String args[]){
		...
		do{
			...
			System.out.print("Please enter your security key(simple letters) : ");
			String key = userInput.next();
			
			System.out.print("What did you need to Encode or Decode? (e/d) : ");
			char whatDo = userInput.next().charAt(0);
			userInput.nextLine();
			
			if(whatDo == 'e'){
				System.out.print("Please enter the text you want to encode : ");
				String pText = userInput.nextLine();
				encode(key,pText);

			}
			else{
				System.out.print("Please enter the cipher text you want to decode : ");
				String cText = userInput.nextLine();
				decode(key,cText);

			}

			System.out.print("Did you need run again? (y/n)");
